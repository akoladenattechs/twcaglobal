...
<body>
    <div class="container">
        ...
        <div class="body">
            <p>Hello,</p>
            <p>We received a request to reset the password for your admin account at <strong>{{ $siteTitle }}</strong>.</p>
            <p>Use the One-Time Password (OTP) below to proceed. This code is valid for <strong>10 minutes</strong>.</p>
